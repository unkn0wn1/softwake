...
| **3** | Connectors (boundary first; live backends still open) + long-term memory decision (local trait; durable store still open); policy engine ([ADR 0010](ADR-0010-policy-engine.md)) |
